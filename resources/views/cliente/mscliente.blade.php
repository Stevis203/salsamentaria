...
<body>
    ...
    <h1 style="text-align: center; margin: 10px; font-family: 'Times New Roman', Times, serif">MIRA LOS CLIENTES DE LA EMPRESA</h1>
    <div class="container">
        <table class="table table-bordered">
            ...
            <tr style="text-align: center">
                ...
                <td><a href="{{ route('mscliente.destroy', $clie->id)}}"><button type="button" class="btn btn-danger" onclick="return confirm('Esta seguro de eliminar este cliente')">ELIMINAR</button></a></td>
            </tr>
            @endforeach
        </table> 
    </div>
