...
<head>
    ...
    <title>Contacto - Salsamentaria Juanchos</title>
    <link rel="stylesheet" href="{{ asset('css/contactos.css') }}"><!-- Agrega tu archivo CSS personalizado -->
            ...
            <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
                <div class="container">
                    <a class="navbar-brand" href="{{ url('/') }}">
                        <h2 style="font-family: 'Times New Roman', Times, serif">Contactos</h2>
                    </a>
